...
class pharmacy:
    def __init__(self,root):
        ...
        ####### main buttons########
        btnAddData = HoverButton(ButtonFrame, command=self.Add_data, text="Medicine Add",
                                 font=("Times New Roman", 10, "bold"), width=15, bg="dodgerblue3", fg="White",
                                 relief=RAISED)
        btnAddData.grid(row=0, column=0)

        btnUpdateMed=HoverButton(ButtonFrame,text="Update",font=("Times New Roman",10,"bold"),width=14,bg="chartreuse4",fg="white",command=self.UpdateMed,relief=RAISED)
        btnUpdateMed.grid(row=0,column=1)


        btnDeleteMed=HoverButton(ButtonFrame,text="Delete",font=("Times New Roman",10,"bold"),width=14,bg="Red",fg="white",command=self.delete,relief='raised')
        btnDeleteMed.grid(row=0,column=2)

        btnResetMed=HoverButton(ButtonFrame,text="Resest",font=("Times New Roman",10,"bold"),width=14,bg="dodgerblue3",fg="white",command=self.reset,relief=RAISED)
        ...
        showAll=HoverButton(ButtonFrame,command=self.fetch_data,text="Show All",font=("Times New Roman",10,"bold"),width=14,bg="dodgerblue3",fg="white",relief=RAISED)
        ...
        search_combo=ttk.Combobox(ButtonFrame,textvariable=self.search_var,width=12,font=("Times New Roman",10,"bold"),state="readonly")
        ...
        searchbtn=HoverButton(ButtonFrame,command=self.search_data,text="Search",font=("Times New Roman",10,"bold"),width=14,bg="dodgerblue3",fg="white",relief=RAISED)
        ...
        ref_combo=ttk.Combobox(DataFrameLeft,textvariable=self.ref_var,width=27,font=("Times New Roman",12,"bold"),state="readonly")
        ...
        txtcomp_name=Entry(DataFrameLeft,textvariable=self.cmpName_var,font=("Times New Roman",12,"bold"),bg="white",bd=2,relief=SOLID,width=29)
        ...
        typeMed_combo=ttk.Combobox(DataFrameLeft,textvariable=self.typeMed_var,width=27,font=("Times New Roman",12,"bold"),state="readonly")
        ...
        Medname_combo=ttk.Combobox(DataFrameLeft,textvariable=self.medName_var,width=27,font=("Times New Roman",12,"bold"),state="readonly")
        ...
        txtlot_no=Entry(DataFrameLeft,textvariable=self.lot_var,font=("Times New Roman",12,"bold"),bg="white",bd=2,relief=SOLID,width=29)
        ...
        txtIssue_date=Entry(DataFrameLeft,textvariable=self.issuedate_var,font=("Times New Roman",12,"bold"),bg="white",bd=2,relief=SOLID,width=29)
        ...
        txtExp_date=Entry(DataFrameLeft,textvariable=self.expdate_var,font=("Times New Roman",12,"bold"),bg="white",bd=2,relief=SOLID,width=29)
        txtExp_date.grid(row=6,column=1)

        lbluses=Label(DataFrameLeft,text="Uses",font=("Times New Roman",12,"bold"),padx=2,pady=6)
        lbluses.grid(row=7,column=0,sticky=W)
        txtuses=Entry(DataFrameLeft,textvariable=self.uses_var,font=("Times New Roman",12,"bold"),bg="white",bd=2,relief=SOLID,width=29)
        ...
        txtside_effect=Entry(DataFrameLeft,textvariable=self.sideeffect_var,font=("Times New Roman",12,"bold"),bg="white",bd=2,relief=SOLID,width=29)
        ...
        txtPrec_warning=Entry(DataFrameLeft,textvariable=self.warning_var,font=("Times New Roman",12,"bold"),bg="white",bd=2,relief=SOLID,width=29)
        ...
        txtDosage=Entry(DataFrameLeft,textvariable=self.dosage_var,font=("Times New Roman",12,"bold"),bg="white",bd=2,relief=SOLID,width=29)
        ...
        txtPrice=Entry(DataFrameLeft,textvariable=self.price_var,font=("Times New Roman",12,"bold"),bg="white",bd=2,relief=SOLID,width=29)
        ...
        txtQty=Entry(DataFrameLeft,textvariable=self.qty_var,font=("Times New Roman",12,"bold"),bg="white",bd=2,relief=SOLID,width=29)
      ...
      if self.ref_var.get() == "" or self.lot_var.get() == "":
        messagebox.showerror("Error","All fields are required")
            ...
            my_cursor.execute("INSERT INTO pharmacy VALUES (%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s)",
                  (int(self.ref_var.get()),
                   self.cmpName_var.get(),
                   self.typeMed_var.get(),
                   int(self.lot_var.get()),
    ...
    def get_cursor(self, event=""):
        ...
        row = None  # Initialize row to None or an empty list here
        if cursor_row:
            content = self.pharmacy_table.item(cursor_row)
            row = content["values"]

        if row:
            self.fetch_data()  # Update the pharmacy table to ensure the data is up-to-date
    ...
    def Update(self):
        if self.lot_var.get() == "":
            ...
            my_cursor = conn.cursor()
            my_cursor.execute(
            "UPDATE pharmacy SET CmpName=%s, Typemed=%s, Issuedate=%s, Expdate=%s, Sideeffect=%s, warning=%s, Dosage=%s, Price=%s, qty=%s, medname=%s, uses=%s WHERE LotNo=%s",
            (
                self.cmpName_var.get(),
                self.typeMed_var.get(),
                self.issuedate_var.get(),
    ...
    def delete(self):
        ...
        if self.lot_var.get() == "":
            ...
            sql = "DELETE FROM pharmacy WHERE LotNo=%s"
            val = (self.lot_var.get(),)
            my_cursor.execute(sql, val)
    ...
    def reset(self):
        if self.ref_var.get() == "" or self.lot_var.get() == "":
            messagebox.showerror("Error", "Nothing to reset")
        else:
            #self.ref_var.set(""),
    ...
    def search_data(self):
        ...
        search_query = (
        "SELECT * FROM pharmacy WHERE Ref_no LIKE %s OR medname LIKE %s OR LotNo LIKE %s"
        )

        my_cursor.execute(search_query, (f"%{search_term}%", f"%{search_term}%", f"%{search_term}%"))
        rows = my_cursor.fetchall()
